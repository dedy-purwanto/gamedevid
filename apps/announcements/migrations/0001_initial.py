...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('announcements_announcement', (
            ...
            ('post', self.gf('django.db.models.fields.related.OneToOneField')(related_name='announcement', unique=True, to=orm['posts.Post'])),
        ))
    ...
    models = {
        'announcements.announcement': {
            ...
            'post': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'announcement'", 'unique': 'True', 'to': "orm['posts.Post']"})
        },
        'auth.group': {
