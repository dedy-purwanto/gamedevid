...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Tag.code'
        db.delete_column(u'tag', 'code')


    def backwards(self, orm):
        
        # Adding field 'Tag.code'
        db.add_column(u'tag', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length='255', blank=True), keep_default=False)
