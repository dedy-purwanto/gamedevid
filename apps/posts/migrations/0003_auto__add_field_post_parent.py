...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'post', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.Post'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Post.parent'
        db.delete_column(u'post', 'parent_id')
