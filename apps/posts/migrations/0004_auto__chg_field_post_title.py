...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'post', 'title', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Post.title'
        db.alter_column(u'post', 'title', self.gf('django.db.models.fields.TextField')())
